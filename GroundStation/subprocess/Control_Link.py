...
def working():
        print("[Control_Link]打开地面站接收器...等待链接...")
        vars.label_1.config(text="[Control_Link]打开地面站接收器,等待连接...")
        try:
            ...
            vars.label_1.config(text="[Control_Link]地面站接收器发生异常...")
            print("[Control_Link]地面站接收器发生异常...")
        finally:
